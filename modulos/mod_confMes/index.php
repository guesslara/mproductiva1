<?      
	...
	$objLog=new regLog();
	$objLog->consulta($_SESSION[$txtApp['session']['loginUsuario']],date("Y-m-d"),date("H:i:s"),$_SERVER['REMOTE_ADDR'],"ADMINISTRACION",$_SESSION[$txtApp['session']['origenSistemaUsuario']]);
...
<script type="text/javascript">
	...
	function redimensionar(){
		...
		$("#muestraasignaciones").css("height",(altoCuerpo-8)+"px");
		$("#ventanaEnsambleContenido2").css("height",altoCuerpo+"px");
		$("#muestraasignaciones").css("width",(anchoDiv-12)+"px");
...
<div id="contenedorEnsamble">
	<div id="contenedorEnsamble3">
		<div id="barraOpcionesEnsamble">
			<div class="opcionesEnsamble" onclick="nuevoregis();" title="">Nuevo Registro</div>
