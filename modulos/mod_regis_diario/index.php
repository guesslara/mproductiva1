...
<div id="buscaDiv" class="transparenciaGeneral" style="display:none;">
...
<div id="modRegT" class="transparenciaGeneral" style="display:none;">
	<div id="contenedorDiv" class="contenedorDiv">
			...
			<div id="modVal" style="width:97%;height:85%;background-color:#fff;border:1px solid #000;margin:5px;float:left;"></div>
